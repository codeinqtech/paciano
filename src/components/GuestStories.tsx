  ...
  const RevealItem = ({
    ...
    useEffect(() => {
      ...
      const observer = new IntersectionObserver(
        ([entry]) => {
          /*
           * Replay the reveal every time the element enters the viewport.
           * Scrolling away resets it; scrolling back runs the stagger again.
           */
  ...
  const GuestStories = () => {
    ...
    return (
      <section className="relative isolate overflow-hidden bg-[#f4efe4] text-[#1d2828]">
        ...
        ========================================================= */}
{/*   
        <RevealItem delay={360} className="-mt-6">
          <div
            className="
              relative
              z-0
